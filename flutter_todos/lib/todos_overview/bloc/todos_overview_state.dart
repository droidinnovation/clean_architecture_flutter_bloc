...
class TodosOverviewState extends Equatable {
  ...
  //the default getters and setters, we have a custom getter called filteredTodos. The UI uses BlocBuilder to access either state.filteredTodos or state.todos.
